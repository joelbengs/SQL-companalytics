...
ALTER TABLE CEO ADD CONSTRAINT ceo_fk FOREIGN KEY(educationLevel) REFERENCES Education(educationLevel);
...
ALTER TABLE AcquiredCompany ADD CONSTRAINT acq_company_fk FOREIGN KEY (acqCompanyName) REFERENCES Company(companyName);
ALTER TABLE ActiveIn ADD CONSTRAINT active_comp_fk FOREIGN KEY (companyName) REFERENCES Company(companyName);
ALTER TABLE ActiveIn ADD CONSTRAINT active_indus_fk FOREIGN KEY (industryName) REFERENCES Industry(industryName);
ALTER TABLE ListedOn ADD CONSTRAINT listed_exch_fk FOREIGN KEY (exchangeName) REFERENCES StockExchange(exchangeName);
ALTER TABLE ListedOn ADD CONSTRAINT listed_comp_fk FOREIGN KEY (companyName) REFERENCES Company(companyName);
ALTER TABLE ListedOn ADD CONSTRAINT listed_stock_fk FOREIGN KEY (stockPrice) REFERENCES StockInfo(stockPrice);
ALTER TABLE Invests ADD CONSTRAINT invest_inv_fk FOREIGN KEY (investorName) REFERENCES Investor(investorName);
ALTER TABLE Invests ADD CONSTRAINT invest_comp_fk FOREIGN KEY (companyName) REFERENCES Company(companyName);